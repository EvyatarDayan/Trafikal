...
struct TrafikalApp: App {
    ...
    private let questionProgress = TheoryQuestionProgressStore.shared
    private let signProgress = SignProgressStore.shared
    private let tabRouter = AppTabRouter.shared
